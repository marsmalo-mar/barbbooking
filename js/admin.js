    ...
    $.each(appointments, function(i, booking) {
      ...
      $card.html(`
        ...
        <div class="appointment-card-body">
          ...
          <div class="appointment-info-item">
            <span class="appointment-label">Barber:</span>
            <span class="appointment-value">${booking.barber?.name || 'N/A'}</span>
          </div>
          <div class="appointment-info-item">
      ...
      $card.html(`
        ...
        <div class="service-admin-card-body">
          <div class="service-admin-image-container">
            <img src="${imageUrl}" alt="${service.name}" class="service-admin-image" onerror="this.src='https://barbershop.ccs4thyear.com/storage/uploads/default.png'">
          </div>
...
async function loadAdminUsers() {
  ...
  try {
    ...
    $.each(users, function(i, user) {
      const avatarUrl = user.avatar ? `${API_URL.replace('/api', '')}/${user.avatar}` : 'https://barbershop.ccs4thyear.com/storage/uploads/profile.png';
      const isSuperAdmin = user.id === 1;
      const $card = $('<div>', { class: 'user-card' });
      $card.html(`
        <div class="user-card-header">
          <div class="user-avatar-wrapper">
            <img src="${avatarUrl}" alt="${user.name}" class="user-card-avatar" onerror="this.src='https://barbershop.ccs4thyear.com/storage/uploads/profile.png'">
          </div>
...
async function loadAdminProfile() {
  try {
    ...
    const avatarUrl = user.avatar ? `${API_URL.replace('/api', '')}/${user.avatar}` : 'https://barbershop.ccs4thyear.com/storage/uploads/default.png';
